...
class TestAll(unittest.TestCase):
    ...
    def test_max_priority_queue(self):
        self.assert_cpp_tests(["max_priority_queue.cpp", "test_max_priority_queue.cpp"], "test_max_priority_queue")

    @weight(1)
    def test_max_priority_queue_analysis(self):
        self.assert_exists(["max_priority_queue.cpp", "test_max_priority_queue.cpp"])
        self.assert_analysis_tests("max_priority_queue.md")
    ...
    def test_heapsort(self):
        self.assert_cpp_tests(["heapsort.cpp", "test_heapsort.cpp"], "test_heapsort")
