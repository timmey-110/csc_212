...
class TestAll(unittest.TestCase):
    ...
    def test_singly_linked_list(self):
        self.assert_cpp_tests(["singly_linked_list.h", "singly_linked_list.cpp", "test_singly_linked_list.cpp"],
                              "test_singly_linked_list")

    @weight(1)
    def test_singly_linked_list_analysis(self):
        self.assert_exists(["singly_linked_list.h", "singly_linked_list.cpp", "test_singly_linked_list.cpp"])
        self.assert_analysis_tests("singly_linked_list.md")

    @weight(1)
    def test_doubly_linked_list(self):
        self.assert_cpp_tests(["doubly_linked_list.h", "doubly_linked_list.cpp", "test_doubly_linked_list.cpp"],
                              "test_doubly_linked_list")

    @weight(1)
    def test_doubly_linked_list_analysis(self):
        self.assert_exists(["doubly_linked_list.h", "doubly_linked_list.cpp", "test_doubly_linked_list.cpp"])
        self.assert_analysis_tests("doubly_linked_list.md")

    @weight(1)
    def test_skiplist(self):
        self.assert_cpp_tests(["skiplist.h", "skiplist.cpp", "test_skiplist.cpp"],
                              "test_skiplist")
